...
@Component({
  selector: 'app-lotes-peq-table',
  templateUrl: './lotes-peq-table.component.html',
  styleUrls: ['./lotes-peq-table.component.css']
})
export class LotesPeqTableComponent implements OnInit {
  tanks: any = [];
